...
setup(
    ...
    # ***package setup***
    name='Travel-Henge',  # package name
    version='0.0a0',
    ...
    url='https://github.com/C-S-Cannon/Travel-Henge',
    author='Cameron Cannon',
    author_email='c_cannon@ucsb.edu',
    license='GPL-3.0',
    description="A python package for taking two geographic coordinates and calculating any occurring henge."
)
